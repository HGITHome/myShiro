...
//            switch(entFieldType) {
//                case "Date":
//                    return (enToDto)? TypeConverter.convertObject(Date.class, obj):TypeConverter.convertObject(Date.class,obj.toString());
//                case "Timestamp":
//                    return TypeConverter.convertObject(Timestamp.class,obj);
//                case "Integer":
